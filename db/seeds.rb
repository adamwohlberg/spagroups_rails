...
Retreat.create!([
  {arrival_date: "2015-10-08", spa_id: 1, group_leader_id: nil, name: "Cool name 1", registered: 12, confirmed: nil, group_rates_at: 8, comp_stay_at: 12, facebook_url: nil, image: nil, facebook_image: nil, description: nil, paypal: nil},
  {arrival_date: "2015-10-08", spa_id: 2, group_leader_id: nil, name: "Old ladies YO!", registered: 12, confirmed: nil, group_rates_at: 8, comp_stay_at: 12, facebook_url: nil, image: nil, facebook_image: nil, description: nil, paypal: nil},
  {arrival_date: "2015-10-08", spa_id: 1, group_leader_id: nil, name: "Cool name 3", registered: 12, confirmed: nil, group_rates_at: 8, comp_stay_at: 12, facebook_url: nil, image: nil, facebook_image: nil, description: nil, paypal: nil},
  {arrival_date: "2015-10-08", spa_id: 3, group_leader_id: nil, name: "Cool name 5", registered: 12, confirmed: nil, group_rates_at: 8, comp_stay_at: 12, facebook_url: nil, image: nil, facebook_image: nil, description: nil, paypal: nil},
